...
function roots_scripts() {
  ...
  wp_enqueue_style('kentblogs_css', get_template_directory_uri() . $assets['css'], false, null);
  ...
  wp_enqueue_script('kentblogs_js', get_template_directory_uri() . $assets['js'], array(), null, true);
}
